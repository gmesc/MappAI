# Piano di Implementazione: Protezione e Monetizzazione MappAI
...
*   **Come funziona**:
    ...
    *   Alla quarta generazione, compare un modale "Sblocca MappAI PRO" che richiede un Codice di Accesso.
...
*   **Come funziona**:
    ...
    *   MappAI si connette *una sola volta* a internet, "chiede" ai server di Gumroad se la chiave è vera e non è stata usata da troppe persone, e se lo è, sblocca l'app.
...
*   **Come funziona**:
    *   MappAI all'avvio richiede una combinazione di Email e Password.
