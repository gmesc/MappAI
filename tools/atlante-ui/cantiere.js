...
const FUORI_ATLANTE = [
    ...
    { nome: '«File condivisi» — contenitore mancante', stato: 'daFare',
      dove: 'decidere: ricostruire o pensionare',
      file: ['public/js/mappai-landing-teach.js'],
      nota: 'renderSharedMat scrive in `teach-shared-body`, che non esiste. La console la tiene fuori: una voce che porta a una vista vuota è peggio di una voce che non c\'è.' },
