const en_translations = {
    ...
    guide_step5_desc: "Double tap a node to read/edit notes. Pinch to zoom. Drag to move. Long press for context menu (quiz, expand, flashcards). Use 'Pin' to lock positions.",
    guide_step6_title: "💾 Step 6 — Save and Resume",
    guide_step6_desc: "Maps are automatically saved. Recent projects appear on the landing page bar. You can import/export JSON files. Share entire vault folders via the Files app using AirDrop.",
