...
#ifndef MAPPAI_STUDENTE_SWIFT_H
#define MAPPAI_STUDENTE_SWIFT_H
...
# undef any
# pragma clang attribute push(__attribute__((external_source_symbol(language="Swift", defined_in="MappAI_Studente",generated_declaration))), apply_to=any(function,enum,objc_interface,objc_category,objc_protocol))
...
SWIFT_CLASS("_TtC15MappAI_Studente11AppDelegate")
...
@class NSString;
SWIFT_CLASS_NAMED("KeychainPlugin")
@interface KeychainPlugin : CAPPlugin
- (void)setSecret:(CAPPluginCall * _Nonnull)call;
- (void)getSecret:(CAPPluginCall * _Nonnull)call;
- (void)deleteSecret:(CAPPluginCall * _Nonnull)call;
