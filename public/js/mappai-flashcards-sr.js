    ...
    sortedSets.forEach(set => {
        ...
        div.innerHTML = `
            ...
            <div class="ml-3 shrink-0 flex items-center gap-1">
                ...
                ${set.mode === 'quiz' ? `<button onclick="event.stopPropagation(); window.MappAILive && window.MappAILive.openSetup && window.MappAILive.openSetup();" class="p-1.5 rounded-lg hover:bg-emerald-50 text-emerald-500 hover:text-emerald-700 transition-colors flex-shrink-0" title="${window.t('tt_launch_live', 'Avvia come attività live (QR)')}">
